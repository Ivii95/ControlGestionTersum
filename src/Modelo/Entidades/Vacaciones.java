...
public class Vacaciones implements Serializable {
    ...
    public Vacaciones(int id, String codigo, String codigo_trabajador, LocalDate fecha_inicio, LocalDate fecha_fin, String motivo) {
        this.id = id;
        this.codigo = codigo;
    ...
    public Vacaciones(String codigo, String codigo_trabajador, LocalDate fecha_inicio, LocalDate fecha_fin, String motivo) {
        this.codigo = codigo;
        this.codigo_trabajador = codigo_trabajador;
        this.fecha_inicio = fecha_inicio;
        this.fecha_fin = fecha_fin;
