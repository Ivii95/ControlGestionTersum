            ...
            switch (opcionborrar) {
                case 0://OPCION SI BORRAR TRABAJADOR
                    int id = Integer.parseInt(String.valueOf(tabla_centros.getValueAt(filaSeleccionada, 0)));
                     {
                        int confirmar = JOptionPane.showConfirmDialog(this, "¿Quieres borrar todos los trabajadores de este centro?", "Trabajadores", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null);
                        if (JOptionPane.YES_OPTION == confirmar) {
                            cr.deleteAllTrabajadoresByCentro(id + "");
