...
public class Contratos_vista extends javax.swing.JFrame {
    ...
    private void btn_modificar_contratoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificar_contratoActionPerformed
        ...
        if (comparacionfechas < 0) {
            ...
            Contrato contrato = new Contrato(codigo_tipo_contrato, codigo_trabajador, UtilidadesPantalla.convertToLocalDateViaInstant(fechainicio), UtilidadesPantalla.convertToLocalDateViaInstant(fechafin), horas, situacion, asegurado);
    ...
    private void rellenardatos(int filaSeleccionada) {
        ...
        for (int i = 0; i < utilidades.lista_de_contratos.size(); i++) {
            ...
            if (contrato.getId() == id) {
                ...
                txt_fechainicio_contrato.setDate(java.sql.Date.valueOf(contrato.getFechainicio()));
                txt_fechafin_contrato.setDate(java.sql.Date.valueOf(contrato.getFechafin()));
